...
class ModelParams {
  ...
  public:
    ...
    LSTM1Params word_left_lstm2; //left lstm
    LSTM1Params word_right_lstm2; //right lstm
    BiParams word_tanh_conv3;
  ...
  public:
    bool initial(HyperParams &opts, AlignedMemoryPool *mem) {
        ...
        word_left_lstm1.initial(opts.word_lstm_dim, opts.word_hidden1_dim, mem); //left lstm
        word_right_lstm1.initial(opts.word_lstm_dim, opts.word_hidden1_dim, mem); //right lstm
        word_tanh_conv2.initial(opts.word_hidden2_dim, opts.word_lstm_dim, opts.word_lstm_dim, true, mem);

        word_left_lstm2.initial(opts.word_lstm_dim, opts.word_hidden2_dim, mem); //left lstm
        word_right_lstm2.initial(opts.word_lstm_dim, opts.word_hidden2_dim, mem); //right lstm
        word_tanh_conv3.initial(opts.word_hidden2_dim, opts.word_lstm_dim, opts.word_lstm_dim, true, mem);
    ...
    void exportModelParams(ModelUpdate &ada) {
        ...
        word_left_lstm2.exportAdaParams(ada);
        word_right_lstm2.exportAdaParams(ada);
        word_tanh_conv3.exportAdaParams(ada);
