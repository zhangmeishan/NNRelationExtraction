...
class ModelParams {
  ...
  public:
    bool initial(HyperParams &opts, AlignedMemoryPool *mem) {
        ...
        word_left_lstm2.initial(opts.word_lstm_dim, opts.word_hidden_dim, mem); //left lstm
        word_right_lstm2.initial(opts.word_lstm_dim, opts.word_hidden_dim, mem); //right lstm
        word_tanh_conv3.initial(opts.word_hidden_dim, opts.word_lstm_dim, opts.word_lstm_dim, true, mem);
