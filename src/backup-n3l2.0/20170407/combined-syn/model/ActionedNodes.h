...
struct ActionedNodes {
    ...
    LookupNode ner_input1;
    LookupNode ner_input2;
...
public:
	inline void initial(ModelParams &params, HyperParams &hyparams, AlignedMemoryPool *mem) {
        ...
        ner_input1.setParam(&(params.ner_table));
        ner_input1.init(hyparams.ner_dim, hyparams.dropProb, mem);
        ner_input2.setParam(&(params.ner_table));
        ner_input2.init(hyparams.ner_dim, hyparams.dropProb, mem);
        /*
...
public:
	inline void forward(Graph *cg, const vector<CAction> &actions, const AtomFeatures &atomFeat, PNode prevStateNode) {
        ...
        if (atomFeat.next_dist == 0) {
            ...
            //entity-level
            PNode left_lstm_node_end = (atomFeat.next_i > 0) ? &(atomFeat.p_word_left_lstm->_hiddens[atomFeat.next_i - 1]) : &bucket;
            ...
            */
            ...
            ner_input1.forward(cg, atomFeat.label_i);
