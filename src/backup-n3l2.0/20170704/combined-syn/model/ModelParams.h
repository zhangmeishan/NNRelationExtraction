...
public:
    ...
    TreeLSTM1Params dep_b2t_lstm;
    TreeLSTM1Params dep_t2b_lstm;
    BiParams dep_word_tanh_conv;
...
public:
    bool initial(HyperParams &opts, AlignedMemoryPool *mem) {
        ...
        dep_b2t_lstm.initial(opts.tree_lstm_dim, opts.tree_input_dim, &embeded_labels, mem);
        dep_t2b_lstm.initial(opts.tree_lstm_dim, opts.tree_input_dim, &embeded_labels, mem);
        dep_word_tanh_conv.initial(opts.word_hidden_dim, opts.tree_lstm_dim, opts.tree_lstm_dim, true, mem);
    ...
    void exportModelParams(ModelUpdate &ada) {
        ...
        dep_b2t_lstm.exportAdaParams(ada);
        dep_t2b_lstm.exportAdaParams(ada);
        dep_word_tanh_conv.exportAdaParams(ada);
