...
public:
    bool initial(HyperParams &opts, AlignedMemoryPool *mem) {
        ...
        ext_word_tanh_conv1.initial(opts.word_hidden_dim, opts.word_lstm_dim, opts.word_lstm_dim, true, mem);
    ...
    void exportModelParams(ModelUpdate &ada) {
        ...
        ext_word_tanh_conv1.exportAdaParams(ada);
