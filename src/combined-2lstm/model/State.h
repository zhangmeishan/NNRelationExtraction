...
public:
    ...
    inline void prepare(HyperParams* hyper_params, ModelParams* model_params, GlobalNodes* global_nodes) {
        ...
        _atomFeat.p_word_tanh_conv1 = global_nodes == NULL ? NULL : &(global_nodes->word_tanh_conv1);
        ...
        _atomFeat.p_word_left_lstm2 = global_nodes == NULL ? NULL : &(global_nodes->word_left_lstm2);
        _atomFeat.p_word_right_lstm2 = global_nodes == NULL ? NULL : &(global_nodes->word_right_lstm2);
        _atomFeat.p_word_tanh_conv3 = global_nodes == NULL ? NULL : &(global_nodes->word_tanh_conv3);
