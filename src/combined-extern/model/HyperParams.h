...
public:
    ...
    void setRequared(Options &opt) {
        ...
        ner_state_concat_dim = action_lstm_dim + 2 * (2 * word_context + 1) * word_hidden_dim + 2 * word_lstm_dim + 2 * ext_lstm_dim;
        //rel_state_concat_dim = 10 * tree_lstm_dim;
        rel_state_concat_dim = 10 * word_lstm_dim + 10 * ext_lstm_dim + 2 * ner_dim;
