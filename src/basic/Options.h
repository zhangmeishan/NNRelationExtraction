...
const static int max_token_size = 40;
  ...
  public:
    ...
    void setOptions(const vector<string> &vecOption) {
        ...
        for (; i < vecOption.size(); ++i) {
            ...
            if (pr.first == "nerRNNHiddenSize")
                nerRNNHiddenSize = atoi(pr.second.c_str());
    ...
    void showOptions() {
        ...
        std::cout << "nerRNNHiddenSize = " << nerRNNHiddenSize << std::endl;
